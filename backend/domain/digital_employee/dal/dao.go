...
// ProfileDAL 员工画像DAL类型（对外暴露）
type ProfileDAL = profileDAL

// NewProfileDAL 创建员工画像DAL（返回具体类型）
func NewProfileDAL(db *gorm.DB) *ProfileDAL {
...
// TaskAssignmentDAL 任务分配DAL类型（对外暴露）
type TaskAssignmentDAL = taskAssignmentDAL

// NewTaskAssignmentDAL 创建任务分配DAL（返回具体类型）
func NewTaskAssignmentDAL(db *gorm.DB) *TaskAssignmentDAL {
...
// PerformanceDAL 绩效DAL类型（对外暴露）
type PerformanceDAL = performanceDAL

// NewPerformanceDAL 创建绩效DAL（返回具体类型）
func NewPerformanceDAL(db *gorm.DB) *PerformanceDAL {
