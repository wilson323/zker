...
// botStoreRepositoryImpl Bot商店仓储实现
type botStoreRepositoryImpl struct {
	db *gorm.DB
}

// NewBotStoreRepository 创建Bot商店仓储
func NewBotStoreRepository(db *gorm.DB) BotStoreRepository {
	return &botStoreRepositoryImpl{db: db}
}

// Create 创建商店项目
func (r *botStoreRepositoryImpl) Create(ctx context.Context, item *entity.BotStoreItem) error {
...
// Update 更新商店项目
func (r *botStoreRepositoryImpl) Update(ctx context.Context, item *entity.BotStoreItem) error {
	dalItem := r.entityToModel(item)
...
// GetByID 根据ID获取商店项目
func (r *botStoreRepositoryImpl) GetByID(ctx context.Context, itemID string) (*entity.BotStoreItem, error) {
...
func (r *botStoreRepositoryImpl) GetByBotID(ctx context.Context, botID string) (*entity.BotStoreItem, error) {
	var dalItem model.BotStoreItem
...
// Delete 删除商店项目（软删除）
func (r *botStoreRepositoryImpl) Delete(ctx context.Context, itemID string) error {
...
// List 列出商店项目（分页）
func (r *botStoreRepositoryImpl) List(ctx context.Context, req *ListRequest) ([]*entity.BotStoreItem, int, error) {
...
// Search 搜索商店项目
func (r *botStoreRepositoryImpl) Search(ctx context.Context, req *SearchRequest) ([]*entity.BotStoreItem, int, error) {
	var dalItems []*model.BotStoreItem
	var total int64
...
func (r *botStoreRepositoryImpl) GetPendingReviews(ctx context.Context, page, pageSize int) ([]*entity.BotStoreItem, int, error) {
	var dalItems []*model.BotStoreItem
	var total int64
...
func (r *botStoreRepositoryImpl) IncrementViewCount(ctx context.Context, itemID string) error {
...
func (r *botStoreRepositoryImpl) IncrementDownloadCount(ctx context.Context, itemID string) error {
	if err := r.db.WithContext(ctx).Model(&model.BotStoreItem{}).
		Where("item_id = ?", itemID).
...
// UpdateRating 更新评分
func (r *botStoreRepositoryImpl) UpdateRating(ctx context.Context, itemID string, rating float64) error {
	// 获取当前评分信息
...
// entityToModel 实体转模型
func (r *botStoreRepositoryImpl) entityToModel(item *entity.BotStoreItem) *model.BotStoreItem {
...
// modelToEntity 模型转实体
func (r *botStoreRepositoryImpl) modelToEntity(dalItem *model.BotStoreItem) (*entity.BotStoreItem, error) {
	var tags []string
